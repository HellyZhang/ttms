		...
		<div style="margin-left: 240px;">
			<form class="form-horizontal" id="editTypeForm">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" id="typeNameId" name="name" placeholder="分类名称" class="form-control dynamicClear required">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input type="text" id="parentNameId" name="parentName" readonly="readonly" placeholder="一级分类"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="number" id="typeSortId" name="sort" placeholder="排序号" class="form-control required dynamicClear">
					</div>
				</div>
					<div class="form-group">
		            <label for="noteId" class="col-sm-2 control-label">备注:</label>
		            <div class="col-sm-10">
		            <textarea class="form-control"  id="typeNoteId" name="note"></textarea>
		      </div> 
	</div>
				<div class="form-group">
