...
!function(a){
	var b={initTree:function(b){
		var c=a.extend({},
		this.treegrid.defaults,b);
		return this.each(function(){
			var b=a(this);
			b.treegrid("setTreeContainer",
						a(this)),
	...
	initNode:function(b){
		return this.each(function(){
			...
			b.getTreeGridContainer.apply(this)),
	...
	initChangeEvent:function(){
		...
		return b.on("change",function(){
			var b=a(this);
			b.treegrid("render"),
			b.treegrid("getSetting","saveState")&&b.treegrid("saveState")}),b},
	initEvents:function(){
		var b=a(this);
